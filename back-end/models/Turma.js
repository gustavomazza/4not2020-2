...
const esquema = mongoose.Schema({
   ...
   //quando coloca o atributo entre [] ele se torna multivalorado, ou seja pode cadastrar mais de um
   dias_semana: [{ 
       type: String, 
       required: true,
       enum: ['dom', 'seg', 'ter', 'qua', 'qui', 'sex', 'sáb']
    }],
    //Valores que usam apenas a parte de hora de uma data são manipulados mais facilmente como string
